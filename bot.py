...
2. Жауап нұсқаларын оқы. Егер A/B/C/D/E әріптері көрінбесе, нұсқаларды жоғарыдан
   төмен немесе солдан оңға қарай сана: 1-нұсқа=A, 2-нұсқа=B, 3-нұсқа=C,
   4-нұсқа=D, 5-нұсқа=E.
3. Табылған нәтижені дәл сол нұсқамен салыстыр. ОТВЕТ өрісіндегі әріп пен
   РЕШЕНИЕ ішіндегі мән бір-біріне қайшы келмеуі керек.
4. Соңында өз жауабыңды тағы бір рет тексер: егер түсіндіру басқа нұсқаға
   апарса, әріпті түзет.

Жауапты тек бір жолмен қайтар:
ОТВЕТ: A | РЕШЕНИЕ: қазақша түсінікті қысқа шешім, 45-80 сөз
