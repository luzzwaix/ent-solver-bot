...
2. Сұрақта "екі жауап", "2 жауап", "екі дұрыс", "бірнеше жауап" деген белгі болса,
   ОТВЕТ өрісіне екі әріпті үтірмен жаз: A,C. Егер бір ғана дұрыс жауап сұралса,
   тек бір әріп жаз.
3. Жауап нұсқаларын оқы. Егер A/B/C/D/E әріптері көрінбесе, нұсқаларды жоғарыдан
   төмен немесе солдан оңға қарай сана: 1-нұсқа=A, 2-нұсқа=B, 3-нұсқа=C,
   4-нұсқа=D, 5-нұсқа=E.
4. Табылған нәтижені дәл сол нұсқамен салыстыр. ОТВЕТ өрісіндегі әріп пен
   РЕШЕНИЕ ішіндегі мән бір-біріне қайшы келмеуі керек.
5. Соңында өз жауабыңды тағы бір рет тексер: егер түсіндіру басқа нұсқаға
   апарса, әріпті түзет.
...
ОТВЕТ: A,C | РЕШЕНИЕ: екі нұсқа неге дұрыс екенін қысқа түсіндір.
