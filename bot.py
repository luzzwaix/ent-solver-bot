...
2. Сұрақ түрін анықта:
   - "Вопрос №26-30" немесе қарапайым радио-батырма болса: бір ғана жауап таңда.
   - "Вопрос на соответствие", "сәйкестік", A) және B) жолдары болса: әр жолға
     сәйкес мәнді бер. Формат: ОТВЕТ: A - DDR; B - Serial ATA
   - "множественный выбор", checkbox, "бірнеше жауап", "мән(дер)і" болса:
