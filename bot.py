...
8. Теориялық сұрақтарда бір ғана кілт сөзге алданып жауап берме. Нұсқалардың
   әрқайсын мағынасы бойынша салыстыр, қайсысы сұрақ талабына дәл келетінін таңда.
9. Егер тарих/информатика сұрағында факт, термин, дата, құрылғы, алгоритм,
   код немесе анықтама болса, ішіңнен мына тексерісті жаса:
   "сұрақ нені сұрап тұр?", "әр нұсқа нені білдіреді?", "қай нұсқа дәл сәйкес?".
   Соңғы жауапта тек қорытындысын қысқа жаз.
10. Егер суретте код болса, кодты жол-жолымен орында: айнымалылардың мәнін
    жаңартып отыр, цикл/шарт/continue әсерін ескер, соңғы print мәнін нұсқамен салыстыр.
...
- Информатика: код болса қысқа трассировка жаса; теория болса терминнің нақты мағынасын айтып, шатастыратын нұсқаларды ішіңнен алып таста.
- Қазақстан тарихы: датаны, тұлғаны, оқиғаны немесе себеп-салдарды нақты айт; ұқсас оқиғалармен шатастырма.
